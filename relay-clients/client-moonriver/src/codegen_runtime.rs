    ...
    pub mod runtime_types {
        ...
        pub mod fp_evm {
            ...
            pub struct ExecutionInfoV2<_0> {
                ...
                pub weight_info: ::core::option::Option<
                    runtime_types::fp_evm::WeightInfo,
                >,
                pub logs: ::subxt::ext::subxt_core::alloc::vec::Vec<
                    runtime_types::ethereum::log::Log,
                >,
        ...
        pub mod moonriver_runtime {
            ...
            pub enum RuntimeError {
                ...
                PrecompileBenchmarks(
                    runtime_types::pallet_precompile_benchmarks::pallet::Error,
                ),
                #[codec(index = 120)]
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    ...
                    register_foreign_asset {
                        ...
                        metadata: runtime_types::moonriver_runtime::asset_config::AssetRegistrarMetadata,
        ...
        pub mod pallet_assets {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    ...
                    #[codec(index = 2)]
                    start_destroy { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 3)]
                    destroy_accounts { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 4)]
                    destroy_approvals { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 5)]
                    finish_destroy { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 6)]
                    mint {
                        #[codec(compact)]
                        id: ::core::primitive::u128,
                    ...
                    #[codec(index = 13)]
                    freeze_asset { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 14)]
                    thaw_asset { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 15)]
                    transfer_ownership {
                        #[codec(compact)]
                        id: ::core::primitive::u128,
                    ...
                    #[codec(index = 18)]
                    clear_metadata { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 19)]
                    force_set_metadata {
                        #[codec(compact)]
                        id: ::core::primitive::u128,
                    ...
                    #[codec(index = 26)]
                    touch { #[codec(compact)] id: ::core::primitive::u128 },
                    #[codec(index = 27)]
                    refund {
                        #[codec(compact)]
                        id: ::core::primitive::u128,
            ...
            pub mod types {
                ...
                pub struct AssetAccount<_0, _1, _2, _3> {
                    ...
                    pub reason: runtime_types::pallet_assets::types::ExistenceReason<
                        _0,
                        _3,
                    >,
                    pub extra: _2,
        ...
        pub mod pallet_migrations {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    #[codec(index = 2)]
                    MigrationStarted {
                        migration_name: ::subxt::ext::subxt_core::alloc::vec::Vec<
                            ::core::primitive::u8,
                        >,
                    },
                    #[codec(index = 3)]
        ...
        pub mod pallet_moonbeam_orbiters {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    OrbiterRotation {
                        collator: ::bp_moonriver::AccountId,
                        old_orbiter: ::core::option::Option<
                            ::bp_moonriver::AccountId,
                        >,
                        new_orbiter: ::core::option::Option<
                            ::bp_moonriver::AccountId,
                        >,
                    },
                    #[codec(index = 4)]
            ...
            pub mod types {
                ...
                pub struct FeeDetails<_0> {
                    pub inclusion_fee: ::core::option::Option<
                        runtime_types::pallet_transaction_payment::types::InclusionFee<
                            _0,
                        >,
                    >,
                    pub tip: _0,
        ...
        pub mod xcm_runtime_apis {
            ...
            pub mod dry_run {
                ...
                pub struct CallDryRunEffects<_0> {
                    ...
                    pub local_xcm: ::core::option::Option<
                        runtime_types::xcm::VersionedXcm,
                    >,
